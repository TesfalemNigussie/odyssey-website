...
export const Service = (props) => {
  return (
    <>
      ...
      >
        <span className="font-satoshi text-3xl font-bold leading-9 tracking-normal text-left text-primary">
          Oddjobber Features
        </span>
        <span className="mt-5 font-satoshi text-4xl font-bold leading-14 tracking-normal text-left">
          Explore Key Benefits
        </span>
        <div className="flex gap-10 mt-12">
          <div className="rounded-lg bg-gray-900 py-3 px-20 text-white text-center border-2 border-solid border-gray-900 rounded-8">
            Homeowner
          </div>
          <div className="rounded-lg bg-white  py-3 px-20  text-black border-2 border-solid border-gray-900 rounded-8">
            Service Provider
          </div>
        </div>
        ...
        <div className="flex  gap-10 mt-12 px-20">
          <div className="container mx-auto p-4 border border-solid border-primary rounded-lg mr-4 py-10">
            <div className="flex items-center mb-4">
              ...
              <div>
                {/* Text 1 */}
                <p className="font-satoshi text-2xl font-bold leading-9 tracking-normal text-left">
                  Service Request Management
                </p>
              </div>
            </div>

            <div className="flex items-center font-satoshi text-base font-normal leading-10 tracking-normal text-left">
              Homeowners can submit service requests, specifying the type of
              service needed, preferred date and time, and any additional
              details. Service providers receive and manage service requests
              through the app, streamlining communication.
            </div>
          </div>
          ...
          <div className="container mx-auto p-4 border  border-solid border-primary rounded-lg mr-4 py-10">
            ...
            <div className="flex items-center font-satoshi text-base font-normal leading-10 tracking-normal text-left">
              In-app chat or messaging system for direct communication between
              homeowners and service providers. Notifications and alerts to keep
              both parties informed of updates and responses.
            </div>
          </div>
        </div>
      ...
      <div className="mt-32 flex justify-center  flex-col px-20">
        <div className="font-satoshi text-2xl font-bold leading-9 tracking-normal text-left text-primary">
          How it Works
        </div>
        <div className="font-satoshi text-4xl font-bold leading-16 tracking-normal text-left mt-4">
          How to Get Started
        </div>
        <div className="font-satoshi text-base font-normal leading-7 tracking-normal text-left mt-2">
          Start exploring now and elevate your home care journey!
        </div>

        <div className="flex mt-20">
          <div
            style={{ height: "1147px", width: "832px" }}
            className="relative flex justify-center items-center"
          >
            <div
              style={{ height: "900px", width: "634px" }}
              className="absolute bg-primary top-32 h-5/6 rounded-2xl"
            ></div>
            <img
              style={{ width: "386px", height: "832px" }}
              className="absolute object-cover top-0 left-auto right-auto h-5/6"
              src="/assets/image_2.svg"
              alt=""
            />
            <div
              style={{ width: "634px", height: "448px" }}
              className=" absolute bg-black rounded-tl-2xl rounded-tr-2xl rounded-br-2xl rounded-bl-2xl bottom-28 p-10"
            >
              <div className="font-Satoshi text-3xl font-bold leading-47 tracking-normal text-left text-white">
                Homeowner
              </div>
              <div className="font-Satoshi text-20 font-normal leading-24 tracking-normal text-left text-white">
                How to get started as a homeowner
              </div>
              <div>
                <div className="flex  items-start font-Satoshi text-2xl  font-normal leading-30 tracking-normal text-center text-white  justify-between my-10">
                  <div className="flex space-x-4 items-center">
                    <div className="bg-white-10 w-10 h-10 flex justify-center items-center rounded-full font-Satoshi  font-bold leading-30 tracking-normal text-left">
                      1
                    </div>
                ...
                <div className="flex  font-Satoshi text-2xl  font-normal leading-30 tracking-normal text-left text-white justify-between my-10">
                  <div className="flex space-x-4 items-center">
                    <div className="bg-white-10 w-10 h-10 flex justify-center items-center rounded-full font-Satoshi  font-bold leading-30 tracking-normal text-left">
                      3
                    </div>
                    <div>Search for Services</div>
                  </div>
                  <div className="flex space-x-4 items-center">
                    <div className="bg-white-10 w-10 h-10 flex justify-center items-center rounded-full font-Satoshi  font-bold leading-30 tracking-normal text-left">
                      4
                    </div>
                    <div>Explore Providers</div>
                  </div>
                </div>
                <div className="flex font-Satoshi text-2xl  font-normal leading-30 tracking-normal text-left text-white  justify-between my-10 ">
                  <div className="flex space-x-4 items-center">
